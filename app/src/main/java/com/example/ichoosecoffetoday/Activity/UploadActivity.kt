...
class UploadActivity : AppCompatActivity(), View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private fun simpanData() {
        ...
        val hargaProductInt = hargaProduct.toInt()

        // Dapatkan UID pengguna yang sedang login
        val ownerUid = firebaseAuth.currentUser?.uid ?: ""

        if (filePath != null) {
            // Jika ada gambar yang dipilih, unggah gambar ke Firebase Storage
            val storageReference =
                storageRef.child("images/${System.currentTimeMillis()}_$namaProduct")
                ...
                .addOnSuccessListener { taskSnapshot ->
                    ...
                    storageReference.downloadUrl.addOnSuccessListener { uri ->
                        ...
                        val product = Product(
                            ...
                            selectedCategory,
                            ownerUid,
                            // Set ownerUid dengan UID pengguna yang sedang login
                        )
            ...
            val product = Product(
                ...
                "",
                selectedCategory,
                ownerUid // Set ownerUid dengan UID pengguna yang sedang login
            )
